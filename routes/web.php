...
Route::get('newsletters/{id}/confirm', ['as' => 'newsletters.design', 'uses' => 'NewslettersController@confirm']);
Route::put('newsletters/{id}/design', ['as' => 'newsletters.design.update', 'uses' => 'NewslettersController@dispatch']);
